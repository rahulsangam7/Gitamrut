...
Fetched: 2026-04-28
Note: Sanskrit verse text is fetched from the Vedic Scriptures static API. ASCII pipe verse marks from the source were normalized to Devanagari danda marks (। and ॥).
